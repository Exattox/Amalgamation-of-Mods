LOVELY_INTEGRITY = 'fd91d789360a162f0183d8546ed8051a11c5b24fafa26e46183a555331280477'
...
local function generate_sleeve_card_areas()
    ...
    for i=1, sleeve_count_page do
        sleeve_card_areas[i] = CardArea(G.ROOM.T.x + 0.2*G.ROOM.T.w/2,G.ROOM.T.h, 0.7*G.CARD_W, 0.7*G.CARD_H,
