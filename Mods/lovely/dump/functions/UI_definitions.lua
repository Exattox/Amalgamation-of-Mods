LOVELY_INTEGRITY = '1ff94ed3629846a9f14a5913e0757dc33c2146448bff373b95a9e842c36f4de5'
        ...
        {n=G.UIT.R, config={align = "cm",padding = 0.15}, nodes={
          ...
          {n=G.UIT.C, config={align = "cm",r = 0.1, padding = 0.05, emboss = 0.05, minw = 2.9, colour = G.C.BLACK}, nodes={
            {n=G.UIT.R, config={align = "cm", maxw = 2.8}, nodes={
              {n=G.UIT.T, config={text = localize('ph_blind_score_at_least'), scale = 0.3, colour = G.C.WHITE, shadow = true, id='score_at_least'}}
            }},
