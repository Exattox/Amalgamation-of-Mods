LOVELY_INTEGRITY = 'e71d21475f293aa4451780abb4950906ccafa148c4bd875c8ea5fbf8286f63d6'
        ...
        if args.type == 'name' then
          ...
          final_line[#final_line].nodes[1] = {n=G.UIT.O, config={
            object = DynaText({string = {assembled_string},
              ...
              font = AKYRS.Fonts[part.control.font] and AKYRS.Fonts[part.control.font] or (tonumber(part.control.font) and G.FONTS[tonumber(part.control.font)]),
