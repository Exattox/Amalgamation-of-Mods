LOVELY_INTEGRITY = '16db6901e1f8f9d7ee328c150e572ba75c754cc4496229f69b6f0619bb2b511e'
...
function draw_card(from, to, percent, dir, sort, card, delay, mute, stay_flipped, vol, discarded_only)
    ...
    G.E_MANAGER:add_event(Event({
        ...
        func = function()
            ...
            if card and card.playing_card and Entropy.HasJoker("j_entr_jokerinyellow") then
