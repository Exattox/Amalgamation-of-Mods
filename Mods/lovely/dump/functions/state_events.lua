LOVELY_INTEGRITY = '26697b71b754a923e3a85e344c811ac1c6d56c00f1211cc536d4f279aba8bd4b'
...
function evaluate_play_intro()
    ...
    for i = 1, #G.play.cards do
    	G.GAME.last_hand_played_cards[i] = G.play.cards[i]
    end
    set_hand_usage(text)
...
G.FUNCS.evaluate_round = function()
    ...
    SMODS.calculate_context({akyrs_round_eval = true, dollars = dollars})
