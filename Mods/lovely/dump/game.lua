LOVELY_INTEGRITY = 'f1f0c5512555cedd9b6c16e90fd9f304f320ce47c62014d26c551cdd6a06f178'
...
function Game:start_up()
    ...
    Cryptid.profile_prefix = Cryptid.profile_prefix == "M" and "E" or Cryptid.profile_prefix.."E"
...
function Game:main_menu(change_context) --True if main menu is accessed from the splash screen, false if it is skipped or accessed from the game
    ...
    G.E_MANAGER:add_event(Event({
        ...
        func = (function()
            ...
            play_sound(togabalatro and not togabalatro.has_tried_startup and togabalatro.config.StartUpSound and 'toga_w96', 1, 0.3);if togabalatro then togabalatro.has_tried_startup = true end
